      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-6 lg:px-8 h-full flex items-start sm:items-center justify-center pt-32 pb-12 sm:py-0">
        <div className="text-center space-y-5 sm:space-y-8 w-full">
          <div className={`transition-all duration-1000 delay-300 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            <div className="text-lg sm:text-lg md:text-xl text-gray-300 mb-4 sm:mb-4 font-light h-9 sm:h-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-100 max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-8 font-medium animate-fade-in-up px-4" style={{ animationDelay: '0.2s', textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>Building AI and machine learning solutions that drive innovation and solve real-world challenges through strategic thinking and entrepreneurial vision.</p>
            <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-3 animate-fade-in-up px-4" style={{ animationDelay: '0.3s' }}>
